...
struct Z_Construct_UClass_USmoothSync_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USmoothSync_clearBuffer, "clearBuffer" }, // 145783417
		{ &Z_Construct_UFunction_USmoothSync_ClientSendsTransformToServer, "ClientSendsTransformToServer" }, // 4036450119
		{ &Z_Construct_UFunction_USmoothSync_enableSmoothSync, "enableSmoothSync" }, // 3837165663
		{ &Z_Construct_UFunction_USmoothSync_forceStateSendNextFrame, "forceStateSendNextFrame" }, // 3320857053
		{ &Z_Construct_UFunction_USmoothSync_ServerSendsTransformToEveryone, "ServerSendsTransformToEveryone" }, // 2506543555
		{ &Z_Construct_UFunction_USmoothSync_setSceneComponentToSync, "setSceneComponentToSync" }, // 948858828
		{ &Z_Construct_UFunction_USmoothSync_SmoothSyncEnableClientToServer, "SmoothSyncEnableClientToServer" }, // 286015896
		{ &Z_Construct_UFunction_USmoothSync_SmoothSyncEnableServerToClients, "SmoothSyncEnableServerToClients" }, // 3203178026
		{ &Z_Construct_UFunction_USmoothSync_SmoothSyncTeleportClientToServer, "SmoothSyncTeleportClientToServer" }, // 2502732334
		{ &Z_Construct_UFunction_USmoothSync_SmoothSyncTeleportServerToClients, "SmoothSyncTeleportServerToClients" }, // 94879
		{ &Z_Construct_UFunction_USmoothSync_teleport, "teleport" }, // 1975471266
	};
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USmoothSync_Statics::NewProp_extrapolationMode = { "extrapolationMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USmoothSync, extrapolationMode), Z_Construct_UEnum_SmoothSyncPlugin_ExtrapolationMode, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_extrapolationMode_MetaData), NewProp_extrapolationMode_MetaData) }; // 4007981124
...
struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SmoothSyncPlugin_Source_SmoothSyncPlugin_Public_SmoothSync_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ SyncMode_StaticEnum, TEXT("SyncMode"), &Z_Registration_Info_UEnum_SyncMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3949436823U) },
		{ ExtrapolationMode_StaticEnum, TEXT("ExtrapolationMode"), &Z_Registration_Info_UEnum_ExtrapolationMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4007981124U) },
		{ RestState_StaticEnum, TEXT("RestState"), &Z_Registration_Info_UEnum_RestState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1964923206U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USmoothSync, USmoothSync::StaticClass, TEXT("USmoothSync"), &Z_Registration_Info_UClass_USmoothSync, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USmoothSync), 1286662939U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SmoothSyncPlugin_Source_SmoothSyncPlugin_Public_SmoothSync_h_3392723935(TEXT("/Script/SmoothSyncPlugin"),
