...
FJsonFileConfiguration::FJsonFileConfiguration(const FString& FileName)
{
	...
	{
		UE_LOG(LogPlayFabGSDK, Error, TEXT("Specified configuration file does not exist: %s"), *FileName);
		return;
	}
	...
	{
		UE_LOG(LogPlayFabGSDK, Error, TEXT("Failed to read configuration file: %s"), *FileName);
		return;
	}
	...
	{
		UE_LOG(LogPlayFabGSDK, Error, TEXT("Failed to parse configuration file: %s"), *FileName);
		return;
	}
