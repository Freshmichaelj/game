	...
	: SignalHeartbeatEvent(FPlatformProcess::GetSynchEventFromPool(false))
{
	...
	{
		UE_LOG(LogPlayFabGSDK, Error, TEXT("Heartbeat endpoint and Server id are required configuration values."));
		UE_LOG(LogPlayFabGSDK, Error, TEXT("PlayFab Server SDK will not be initialized."));
		return;
	}
